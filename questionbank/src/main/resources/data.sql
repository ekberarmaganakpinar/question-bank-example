...
insert into PARENT(id,first_name,last_name,student_id) values (5001,'hakkı','yeten',1001);
...
insert into PARENT(id,first_name,last_name,student_id) values (5002,'süleyman','seba',1002);
